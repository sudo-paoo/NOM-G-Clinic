...
Partial Class PatientRegistration
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(PatientRegistration))
        HopeForm1 = New ReaLTaiizor.Forms.HopeForm()
        pnlPatientRegistration = New Panel()
        ...
        Label18 = New Label()
        Label7 = New Label()
        pnlPatientRegistration.SuspendLayout()
        ...
        HopeForm1.Text = "Patient Registration"
        HopeForm1.ThemeColor = Color.FromArgb(CByte(236), CByte(72), CByte(153))
        ' 
        ' pnlPatientRegistration
        ' 
        pnlPatientRegistration.BackgroundImage = My.Resources.Resources.bg_img
        pnlPatientRegistration.BackgroundImageLayout = ImageLayout.None
        pnlPatientRegistration.Controls.Add(tabPatientRegistration)
        pnlPatientRegistration.Controls.Add(Label7)
        pnlPatientRegistration.Dock = DockStyle.Fill
        pnlPatientRegistration.Location = New Point(0, 40)
        pnlPatientRegistration.Name = "pnlPatientRegistration"
        pnlPatientRegistration.Size = New Size(1000, 710)
        pnlPatientRegistration.TabIndex = 1
        ' 
        ...
        tabPatientRegistration.Location = New Point(12, 57)
        ...
        tabPatientRegistration.TabIndex = 3
        ' 
        ' TabPage1
        ' 
        ...
        Label11.Location = New Point(506, 477)
        ...
        Label12.Location = New Point(16, 477)
        ...
        Label10.Location = New Point(16, 330)
        ...
        Label8.Location = New Point(506, 247)
        Label8.Name = "Label8"
        ...
        Label9.Location = New Point(16, 247)
        Label9.Name = "Label9"
        ...
        Label4.Location = New Point(661, 164)
        Label4.Name = "Label4"
        ...
        Label5.Location = New Point(340, 164)
        Label5.Name = "Label5"
        ...
        Label3.Location = New Point(661, 77)
        Label3.Name = "Label3"
        ...
        Label2.Location = New Point(340, 77)
        Label2.Name = "Label2"
        ...
        Label17.Location = New Point(16, 22)
        ...
        labelnum.Location = New Point(16, 241)
        ...
        labelrel.Location = New Point(16, 158)
        ...
        Label7.TabIndex = 2
        Label7.Text = "Patient Registration Form"
        ' 
        ' PatientRegistration
        ' 
        ...
        Controls.Add(pnlPatientRegistration)
        ...
        Text = "PatientRegistration"
        pnlPatientRegistration.ResumeLayout(False)
        pnlPatientRegistration.PerformLayout()
    ...
    Friend WithEvents pnlPatientRegistration As Panel

...
Public Class NurseDashboard
    ...
    Private Sub AppointmentsSetupDataGrid()
        ...
        Dim appointmentTimeColumn As New DataGridViewTextBoxColumn()
        appointmentTimeColumn.HeaderText = "Time"
        appointmentTimeColumn.Name = "AppointmentTime"
        appointmentTimeColumn.MinimumWidth = 80
        appointmentTimeColumn.FillWeight = 10
        dgvAppointments.Columns.Add(appointmentTimeColumn)
    ...
    Private Sub CloseDropdownAppointmentsHandler(sender As Object, e As EventArgs) Handles dgvAppointments.Click, Panel1.Click, pnlAppointments.Click, btnDashboard.Click, btnPatients.Click, btnAppointments.Click, Appointments.Click
        CloseDropdownAppointments()
    End Sub
